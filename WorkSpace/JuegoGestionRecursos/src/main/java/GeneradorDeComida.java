...
public class GeneradorDeComida extends Generador{
    public GeneradorDeComida(int cantidadProducidaPorTurno, int costeMantenimiento, int costeMejora) {
    ...
    public int generarRecurso(Recurso recursoMantenimiento) {
        if(recursoMantenimiento.getTipo() != TipoRecurso.MADERA){
            ...
            if (recursoMantenimiento.getCantidad() < getCosteMantenimiento()) {
                System.out.println("Generador de Comida:");
                System.out.println("No se genero Comida por falta de recursos");
                return 0;
                
            }else{
                recursoMantenimiento.setCantidad(recursoMantenimiento.getCantidad() - getCosteMantenimiento());
                System.out.println("Generador de Comida:");
                System.out.println("Se generaron " + getCantidadProducidaPorTurno() + " de Comida");
